...
%                 % Conductivity
%                 dataElement.sigma = obj.Materials.Conductivity{k};
        ...
        obj = building_Y_vector(obj)
        
        %------------------------------------------------------------------
        % Building the right hand side vector
        %------------------------------------------------------------------

        vector = building_Y_vector_eddy(obj)
        %------------------------------------------------------------------
