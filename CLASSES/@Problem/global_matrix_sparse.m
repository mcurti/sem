function obj = global_matrix_sparse(obj)
		...
		[tmp_rows, tmp_cols] = mehsgrid(i_node,i_node); tmp_v = E(yel,yel);
		
		tmp_length = numel(tmp_ii);
		
		rows(current_index:tmp_length+1) = tmp_rows(:);
		cols(current_index:tmp_length+1) = tmp_cols(:);
		v   (current_index:tmp_length+1) = tmp_v(:);
		...
		%==================================================================
		[tmp_rows, tmp_cols] = mehsgrid(i_node,c_node(ll)); tmp_v = E(yel,yc);
		...
		%==================================================================
		[tmp_rows, tmp_cols] = mehsgrid(c_node(ll),i_node); tmp_v = E(yc,yel);
		...
		%==================================================================
		[tmp_rows, tmp_cols] = mehsgrid(c_node(ll),c_node(ll)); tmp_v = E(yc,yc);
		...
		%==================================================================
		[tmp_rows, tmp_cols] = mehsgrid(i_node,e_node{jj(ii)}); tmp_v = E(yel,yb{ii});
		...
		%==================================================================
		[tmp_rows, tmp_cols] = mehsgrid(e_node{jj(ii)},i_node); tmp_v = E(yb{ii},yel);
		...
		%==================================================================
		[tmp_rows, tmp_cols] = mehsgrid(e_node{jj(ii)},e_node{jj(n)}); tmp_v = E(yb{ii},yb{n});
		...
		%==================================================================
		[tmp_rows, tmp_cols] = mehsgrid(e_node{jj(ii)},c_node(ll)); tmp_v = E(yb{ii},yc);
		...
		%==================================================================
		[tmp_rows, tmp_cols] = mehsgrid(c_node(ll),e_node{jj(ii)}); tmp_v = E(yc,yb{ii});
