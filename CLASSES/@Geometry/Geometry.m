...
classdef Geometry
    ...
    methods
        ...
        function obj = setParameter(obj,Parameter,Value)
            obj = read_geometry(obj,obj.GeometryElement);
...
function obj = read_geometry(obj,A)
...
for k = 1:Np
    points(k,:) =...
        round(eval(['[',xml2matlab(A,'point',k-1,...
