 ...
 *
 * _coder_BarycentricWeights_api.c
 *
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "BarycentricWeights",                /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
void BarycentricWeights_api(const mxArray * const prhs[1], const mxArray *plhs[1])
{
  emxArray_real_T *x;
  emxArray_real_T *w;
...
void BarycentricWeights_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  BarycentricWeights_xil_terminate();
}

void BarycentricWeights_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
void BarycentricWeights_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_BarycentricWeights_api.c) */
